...
print(f"Length of raw dataset is: {len(articles_dict['PMID'])}")
...
print(f"Length of dataset after preprocessing is: {len(df)}")
...
for output in tqdm(embedded_chunks.iter_rows()):
